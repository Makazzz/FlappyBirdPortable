...
user in an INI file next to FlappyBirdPortable.exe called FlappyBirdPortable.ini.
...
copy AppNamePortable.ini from this directory to FlappyBirdPortable.ini next to
FlappyBirdPortable.exe. The options in the INI file are as follows:
